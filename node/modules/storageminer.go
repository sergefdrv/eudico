...
func SetupBlockProducer(lc fx.Lifecycle, ds dtypes.MetadataDS, api v1api.FullNode, epp gen2.WinningPoStProver, sf *slashfilter2.SlashFilter, j journal.Journal) (*lotusminer.Miner, error) {
